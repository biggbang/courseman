...
****
.Inhalt
Es soll eine Kursverwaltung erstellt werden. Diese Kursverwaltung soll bei der Verwaltung von Seminaren unterstützen. Kurzbeschreibung der fachlichen Aufgabenstellung, treibenden Kräfte, Extrakt (oder Abstract) der Anforderungen.
